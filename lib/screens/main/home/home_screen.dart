                    ...
                    children: [
                      const Positioned(
                          ...
                          child: Image(
                            fit: BoxFit.cover,
                            image: NetworkImage(
                              "https://cdn.dribbble.com/users/2321513/screenshots/5977221/media/ecbe947e8ed1326300602ee3fad17ffb.jpg?compress=1&resize=800x600&vertical=top",
                            ),
                          )),
                      Positioned(
                        bottom: -1,
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) => VxBox(
                          ...
                          HStack(
                            ...
                            .width(300.w)
                            .make())).height(420).make().marginOnly(
                bottom: 12.h),
          ],
        ),
      ).color(MyColor.white).make();
